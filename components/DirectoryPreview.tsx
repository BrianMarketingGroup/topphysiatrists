  ...
  return (
    <div className="bg-navy text-white px-3 py-2 sm:px-4 flex items-center gap-4">
      ...
      <div className="flex items-center gap-1.5">
        <Image src="/stethoscope.svg" alt="" width={16} height={16} className="h-4 w-4 object-contain" />
        <span className="flex flex-col items-center">
          <span className="text-white text-xs font-bold leading-none">TopPhysiatrists<span className="text-teal">.com</span></span>
  ...
  return (
    <div className="bg-gray-50 h-full">
      ...
      <div className="bg-navy/95 px-4 py-3 text-center">
        <p className="text-white text-xs sm:text-sm font-semibold">Top Physiatrists in Dallas, TX</p>
      ...
      <div className="px-2 sm:px-3 pb-4 space-y-2">
        <p className="text-[9px] sm:text-[10px] font-semibold text-gray-500 px-1">Top Physiatrists in Dallas, TX</p>
        {ranked.map((company) => (
      ...
      <div className="grid grid-cols-5 gap-0 p-2 sm:p-3">
        <div className="col-span-2 space-y-2 pr-2">
          <div className="bg-white rounded-lg border border-gray-100 p-2">
            <p className="text-[8px] font-bold text-gray-400 uppercase tracking-wider mb-1.5">PM&amp;R Specialties</p>
          ...
          <div className="bg-navy rounded-lg p-2 text-center">
            ...
            <p className="text-[8px] font-bold text-white leading-tight">TopPhysiatrists.com</p>
            <p className="text-[6px] text-white/40 tracking-widest uppercase mt-0.5">Expertise · Care · Excellence</p>
        ...
        <div className="col-span-3 space-y-2">
          <div className="bg-white rounded-lg border border-gray-100 p-2">
            ...
            <p className="text-[9px] text-gray-600 leading-relaxed">
              {company.name} is a top-rated physiatry practice serving the Dallas metro area with expert physical medicine and rehabilitation care for patients and referring physicians.
            </p>
          </div>
          <div className="bg-white rounded-lg border border-gray-100 p-2">
            ...
            {[
              { name: "Stroke Rehabilitation", title: "Board-Certified Physiatrist" },
              { name: "Spinal Cord Injury Rehab", title: "Fellowship Trained" },
            ].map((o) => (
          ...
          <div className="bg-white rounded-lg border border-gray-100 p-2">
            ...
            <div className="space-y-1.5">
              {[
                { author: "M. Thompson", text: "Exceptional rehabilitation care. Compassionate, thorough, and effective." },
                { author: "R. Patel", text: "After my stroke, this team helped me regain my independence. Highly recommend." },
              ].map((r) => (
...
const CALLOUTS: Record<View, { color: string; icon: React.ReactNode; text: React.ReactNode }> = {
  ...
  profile: {
    ...
    text: <><span className="text-navy font-semibold">Professional Profile Page</span> — Every listed physician gets a dedicated profile with photo, PM&amp;R specialties, conditions treated, reviews, contact details, and your TopPhysiatrists.com 2027 recognition badge.</>,
  },
  directory: {
    color: "bg-white border-sky-dark",
    icon: <span className="text-navy text-[10px] font-bold">✓</span>,
    text: <><span className="text-navy font-semibold">Directory Listing</span> — Your practice appears in the ranked directory by city and PM&amp;R specialty. Every visitor can click through to your full professional profile page.</>,
  },
};
...
export default function DirectoryPreview() {
  ...
  const browserUrl =
    view === "profile"
      ? "topphysiatrists.com/physicians/summit-rehabilitation-specialists"
      : "topphysiatrists.com/dallas-tx";
