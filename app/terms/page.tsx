    ...
    <div className="bg-white min-h-screen py-16">
      <Container>
        <div className="max-w-3xl prose prose-sm prose-headings:font-display prose-headings:text-navy prose-a:text-teal">
          ...
          <h2>1. Agreement</h2>
          <p>By submitting a listing application to TopPhysiatrists.com, you agree to these Terms of Service. These terms govern your listing on the TopPhysiatrists.com directory.</p>
          ...
          <p>TopPhysiatrists.com is not responsible for the actions or omissions of any listed professional. The directory is provided for informational purposes only.</p>

          <h2>10. Medical Disclaimer</h2>
          <p>TopPhysiatrists.com is a directory for physiatrists and PM&R specialists. Listings are not a substitute for medical advice. Users should consult a licensed physician for medical diagnosis and treatment.</p>
          ...
          <h2>12. Contact</h2>
          <p>Questions? Email us at <a href="mailto:info@topphysiatrists.com">info@topphysiatrists.com</a>.</p>
        </div>
      </Container>
    </div>
  );
